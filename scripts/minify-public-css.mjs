...
const fontFacesCssPath = "public/font-faces.css";
const easyMdeCssPath = "node_modules/easymde/dist/easymde.min.css";
const outputPath = "public/styles.min.css";

const [fontFacesCss, easyMdeCss, appCss] = await Promise.all([
  readFile(fontFacesCssPath, "utf8"),
  readFile(easyMdeCssPath, "utf8"),
  readFile(appCssPath, "utf8"),
]);
const source = `${fontFacesCss}\n${easyMdeCss}\n${appCss}`;
