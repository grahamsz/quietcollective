...
import { renderDiscussionBoard, renderDiscussions, renderDiscussionThread, renderNewDiscussionBoard } from "./pages/forum";
...
const routes = [
  ...
  ["/discussions/new-board", renderNewDiscussionBoard],
